...
//  static const u4_t DEVADDR = 0x2601184F ; // <-- Change this address for every node!
  ...
  static const PROGMEM u1_t NWKSKEY[16] = { 0x58, 0x9D, 0x8F, 0xED, 0x0C, 0x79, 0x68, 0xE6, 0x16, 0xC1, 0x79, 0x3D, 0x29, 0xC2, 0xE0, 0xCD };
  static const u1_t PROGMEM APPSKEY[16] = { 0x05, 0x18, 0xAD, 0x30, 0xE4, 0xC5, 0xA5, 0xC3, 0x90, 0x45, 0xAD, 0x92, 0xF4, 0xD6, 0x70, 0xDD };
  static const u4_t DEVADDR = 0x26011801;
...
void do_send(osjob_t* j){
    if (LMIC.opmode & OP_TXRXPEND) {
       ...
       digitalWrite(LED_BUILTIN, HIGH);
        ...
        uint8_t buff[12];
        *((int32_t*)&buff[0])=(int)(measuredvbat*100);
        *((int32_t*)&buff[4])=GPS.latitude_fixed;
        *((int32_t*)&buff[8])=GPS.longitude_fixed;
  
        LMIC_setTxData2(1, buff, 12, 0);
